...
5. ЗБЕРІГАЙ ДОВЖИНУ. НЕ скорочуй і НЕ роздувай текст. Кожне речення на виході ≈ та сама довжина, що й на вході (±20% слів). Коротке речення "Одне летить." (2 слова) → залишається коротким (2-3 слова). Довге речення (40 слів) → ~40 слів. ПЕРЕПИСУЙ, а не РЕЗЮМУЙ і не ДОПОВНЮЙ. Не дописуй поради, висновки чи заклики після останнього речення оригіналу.
...
11. ДОВЖИНА – НЕ скорочуй текст. Якщо речення на вході має 40 слів – на виході теж ~40 слів (±5 слів). Не випускай деталі, аргументи, приклади, посилання. ПЕРЕПИСУЙ кожне речення повноцінно, не стискай його до тези.

12. МЕНШ ОЧЕВИДНІ СЛОВА – не бери перший синонім. Замість "допомагає" не "сприяє" (канцелярит!) а "прискорює", "знімає головний біль", "бере на себе". Конкретні дієслова замість абстрактних.

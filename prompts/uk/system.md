...
- professional: Впевнено, по суті, діловий але теплий тон.
  ПРОПУСТИ для цього стилю: розмовні звороти ("знаєш що", "чесно кажучи"), риторичні питання, фрагменти речень, сленг ("фішка", "круто", "кайф", "відстій", "жесть"), зменшувальні ("проблемка", "трішечки"), вигуки.

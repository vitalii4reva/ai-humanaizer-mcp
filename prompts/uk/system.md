...
5. НЕ СКОРОЧУЙ текст. Кожне речення на виході має бути приблизно такої ж довжини, як відповідне на вході (±20% слів). Абзац на 500 символів → результат ~500 символів. ПЕРЕПИСУЙ, а не РЕЗЮМУЙ. Не випускай деталі, приклади, аргументи, посилання на авторів.
